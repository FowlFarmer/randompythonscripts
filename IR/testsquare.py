...
while(True):
    ...
    swimmer.swim_to_wp(speed=1.0, depth=2.0, x = 0.0, y = 10.0)
    swimmer.swim_to_wp(speed=1.0, depth=2.0, x = 10.0, y = 10.0)
    swimmer.swim_to_wp(speed=1.0, depth=2.0, x = 10.0, y = 0.0)